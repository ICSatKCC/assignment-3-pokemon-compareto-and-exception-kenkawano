 ...
 * negative if in p1.compareTo(p2), p1 is "less" than p2 (p1 should come after p2 in the priority queue) 
 * positive if p1 is "greater" than p2 (p1 should come before p2 in the priority queue)
